...
def main():
    nb_class = 5270
    #Create data
    train_gen, val_gen = Data.create_data(G=2)

    #Create Model
    model = InceptionResNetV2(include_top=True,weights=None,input_tensor=None,input_shape=None,pooling=None,bottleneck=None,G=2,classes=nb_class)
